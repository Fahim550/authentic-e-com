  ...
  <section class="mx-auto w-full rounded-2xl bg-white px-4 py-10 sm:px-6 lg:px-14">
    ...
    <div class="relative mt-8">
      ...
      <button
        ...
        class="absolute left-0 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2 flex h-10 w-10 items-center justify-center rounded-full bg-white shadow-lg border border-gray-800 text-[#17172b] transition hover:bg-[#17172b] hover:text-white disabled:opacity-30 disabled:cursor-not-allowed"
        aria-label="Previous"
      >
        <svg
      ...
      <button
        ...
        class="absolute right-0 top-1/2 z-10 translate-x-1/2 -translate-y-1/2 flex h-10 w-10 items-center justify-center rounded-full bg-white shadow-lg border border-gray-800 text-[#17172b] transition hover:bg-[#17172b] hover:text-white disabled:opacity-30 disabled:cursor-not-allowed"
        aria-label="Next"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
